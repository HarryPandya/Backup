...
client.loop_start()
publish("Hariom", "100," + device_name + ",c8y_MQTTDevice", True)
publish("Hariom", "110,S123456789,MQTT test model,Rev0.1")
publish("Hariom", "114,c8y_Restart")
print("Device registered successfully!")

client.subscribe("hari12")
sendMeasurements()
